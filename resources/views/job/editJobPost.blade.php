...
@foreach ($getJobDetails as $getJobDetail)
    <div class="row jobform">
        ...
        <form method="POST" action="{{route('JobPortal.UpdateJobPost',['job_id'=>$getJobDetail->id])}}" enctype="multipart/form-data">
            @csrf
        <div class="col-md-10">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Company Name</label><input type="text"
                            class="form-control" value="{{$getJobDetail->company_name }}" name="company_name" placeholder="Company Name"></div>
                    <div class="col-md-6"><label class="labels">Company Email</label><input type="text"
                            class="form-control" value="{{$getJobDetail->company_email }}" name="company_email" placeholder="Company Email"></div>
                </div>

                <div class="row mt-2">
                    <div class="col-md-12"><label class="labels">Company Detail</label>
                        <textarea type="text" name="comp_detail" class="form-control" placeholder="Company Detail">{{$getJobDetail->company_detail }}</textarea>
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-md-12"><label class="labels">Job Name</label><input type="text"
                            class="form-control" value="{{$getJobDetail->job_name }}" name="job_name" placeholder="Job Name"></div>

                </div>
                <div class="row mt-2">
                    <div class="col-md-12"><label class="labels">Job Description</label>
                        <textarea type="text" name="job_description" class="form-control" placeholder="Job Description">{{$getJobDetail->job_description }}</textarea>
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Job Location</label><input type="text"
                            class="form-control" value="{{$getJobDetail->job_location }}" name="job_location" placeholder="Job Location"></div>
                    <div class="col-md-6"><label class="labels">Salary (₹) </label><input type="text"
                            class="form-control" value="{{$getJobDetail->job_salary }}" name="salary" placeholder="Salary"></div>
                </div>

                <div class="row mt-2">
                    <div class="col-md-12"><label class="labels">Responsibility</label>
                        <textarea type="text" class="form-control" name="resp_desc" placeholder="Responsibility">{{$getJobDetail->job_responsibility }}</textarea>
                    </div>
                    ...
                    <div class="row mt-2" >
                         <div class="col-md-11">
                             <input type="text" value="{{$getRespList->job_responsibilty_list}}" class="form-control" placeholder="Add Responsibilty List" name="resp_list[]" value="">
                            </div>
                            <div class="col-md-1  zoom" ><span   class="removeBtn"><i class="fa fa-trash"></i></span>
                            </div>
                        </div>
                        @endforeach
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-md-12"><label class="labels">Qualifications</label>
                        <textarea type="text" class="form-control" placeholder="Qualifications" name="qualification_desc">{{$getJobDetail->job_qualification}}</textarea>
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-md-12"><label class="labels">Benefits</label>
                        <textarea type="text" class="form-control" placeholder="Benefits" name="benefit_desc">{{ $getJobDetail->job_benefit }}</textarea>
                    </div>
                ...
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Job Vacancy</label><input type="text"
                            class="form-control" value={{$getJobDetail->job_vacancy}} name="job_vacancy" placeholder="Total Vacancy"></div>
                    <div class="col-md-6"><label class="labels">Job Duration</label><input readonly type="date"
                            class="form-control" value="{{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $getJobDetail->job_end_date)->format('Y-m-d') }}"  placeholder="Post End Date"></div>
                </div>
                    ...
                    <div class="col-md-6"><label class="labels">Job Shift</label>
                        <select type="text" class="form-control" placeholder="Job Shift" name="job_shift">
                            ...
                            @foreach ($jobShifts as $jobShift)
                                <option value="{{ $jobShift->id }}" {{ ($getJobDetail->job_shift_id == $jobShift->id ) ? 'selected' : '' }} >{{ $jobShift->job_shift_name }}</option>
                            @endforeach
                    ...
                    <div class="col-md-6">
                        ...
                        <select type="text" name="job_category" class="form-control" placeholder="Job Category">
                            ...
                            @foreach ($jobCategory as $jobCat)
                                <option value="{{ $jobCat->id }}" {{ ($getJobDetail->job_category_id == $jobCat->id) ? 'selected' : '' }}>{{ $jobCat->job_category_name }}</option>
                            @endforeach
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-6"><img id="outputLogo" class="flex-shrink-0 img-fluid border rounded"
                            src="{{ asset('uploads/company_logo/'.$getJobDetail->company_logo) }}" alt="" style="width: 80px; height: 80px;">
                    </div>
                    @else
                    <div class="col-md-6"><img id="outputLogo" class="flex-shrink-0 img-fluid border rounded"

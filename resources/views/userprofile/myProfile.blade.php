                ...
                <div class="card-body-user">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <p class="text-secondary mb-1">{{$editProfile->position}}</p>
                      <p class="text-muted font-size-sm">{{$editProfile->country}},{{$editProfile->state}},{{$editProfile->address}}</p>
              ...
              <div class="card-user mt-3">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <span class="text-secondary">{{$portfolio->portfolio_website_link ?? 'no Link'}}</span>
                      </li>
                    @endforeach
              ...
              <div class="card-user mb-3">
                <div class="card-body-user">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                        {{$editProfile->country}},{{$editProfile->state}},{{$editProfile->address}}
                    </div>
                  </div>
                  <hr>

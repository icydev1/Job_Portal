                ...
                @endif
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                            ...
                            <div class="col-md-6"> <input value="{{$editProfiles->website_link}}" name="website_link" class="form-control" type="text">
                            </div>
                            </div>
                      ...
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                          <div class="row">
                              ...
                              <div class="col-md-6"> <input value="{{$editProfiles->github_link}}" name="github_link" class="form-control" type="text">
                            </div>
                            </div>
                    ...
                    <div class="col-md-6"> <input value="{{$editProfiles->twitter_link}}" name="twitter_link" class="form-control" type="text">
                  </div>
                  </div>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <div class="col-md-6"> <input value="{{$editProfiles->insta_link}}" name="insta_link" class="form-control" type="text">
                  </div>
                  </div>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="col-md-6"> <input value="{{$editProfiles->fb_link}}" name="fb_link" class="form-control" type="text">
                        </div>
                        </div>
                      </li>
                    </ul>
